...
/* Smarty version 4.2.1, created on 2025-05-02 18:36:52
  from 'module_file_tpl:LISE;help_about_tab.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_6814f4a4cd9d13_08120985',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b3d7193415ab6baa19589e39f9dd3764dbecb573' => 
    array (
      0 => 'module_file_tpl:LISE;help_about_tab.tpl',
      1 => 1746203811,
      2 => 'module_file_tpl',
    ),
  ),
...
function content_6814f4a4cd9d13_08120985 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\ms\\lib\\smarty\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
?>
<div class="pageoverflow">
      ...
      <p>The module author is in no way obligated to provide support for this code in any fashion. However, there are a number of resources available to help you with its use:
        <ul>
          <li>
            If you find any bugs please feel free to submit a bug report <a href="http://dev.cmsmadesimple.org/bug/list/1345" target="_blank">here</a> or for any good ideas consider submiting a feature request <a href="http://dev.cmsmadesimple.org/feature_request/list/1345" target="_blank">here</a>;
          </li>
          <li>
            Additional discussion of this module may also be found in the <a href="http://forum.cmsmadesimple.org">CMS Made Simple Forums</a>.  When describing an issue please make an effort to provide all relevant information, a thorough description of your issue, and steps to reproduce it or your discussion may be ignored;
          </li>
        </ul>
  </p>
  <p>Please keep in mind that developers do have their daily jobs which means that feature requests are considered and done as time allows. If you need a feature really badly consider contacting one of the developers for a sponsored development.</p>
      ...
      <p>If want to help the development and maintenance of this module, please consider <a href="" id="donating">donating</a>.</p>

      <h3>Copyright and License</h3>

			<p class="p_bottom_15">The Module is currently being developed by</p>

			<p class="p_bottom_15"><strong>Fernando Morgado (Jo Morg)</strong>
			<br />
			...
			<p class="p_bottom_15">... with a huge amount of help from</p>
			<p class="p_bottom_15"><strong>Rolf Tjassens (Rolf Tj)</strong>
      <br />
      who's love and commitment for the CMSMS project has been both inspirational and priceless.
			<br />
        Sadly, long time Dev Team member and great friend to CMS Made Simple, Rolf Tjassens passed away unexpectedly on the 30th of May 2022. Farewell Rolf, we will miss you.
			<br />
			Web: <a target="_blank" href="https://rolftjassens.com" rel="external">rolftjassens.com</a>
			<br />
			Don't forget to check his tips and tricks site: <a target="_blank" href="https://cmscanbesimple.org" rel="external">cmscanbesimple.org</a>
			<br />
			and his CMSMS showcase site: <a target="_blank" href="https://welovecmsms.com" rel="external">welovecmsms.com</a>
			</p>
			<hr>
  <?php if (smarty_modifier_date_format(time(),"%Y") == '2015') {
$_smarty_tpl->_assignInScope('cr', '2015');
} else {
ob_start();
echo smarty_modifier_date_format(time(),'%Y');
$_prefixVariable1=ob_get_clean();
$_smarty_tpl->_assignInScope('cr', "2015 - ".$_prefixVariable1);
}?>
 ...
 . All Rights Are Reserved.<br /></p>
      ...
      <hr>
      <h4>Contributors and Sponsors</h4>
      <ul>
        <li><strong>Rolf Tjassens</strong><br />www.cmscanbesimple.org</li>
        ...
        <li><strong>Jonathan Schmid (Foaly*)</strong></li>
        <li><strong>Robert Campbell (calguy1000)</strong><br />www.calguy1000.com</li>
        <li><strong>Lukas Blatter (nockenfell)</strong> nockenfell@gmail.com <br />www.blattertech.ch</li>
        <li><strong>Arnoud (arnoud)</strong></li>
        <li><strong>Wayne ONeil (wishbone)</strong></li>
        ...
        <li><strong>Manuel Schroyens</strong> webmaster@webaholic.be<br />webaholic.be</li>
        <li><strong>Pixel Solutions</strong><br />https://pixelsolutions.biz</li>
        <li><strong>Koa'link</strong><br />https://www.koalink.fr</li>
        <li><strong>Darren Kierman (kierweb)</strong><br />https://www.kierweb.co.uk/</li>
			</ul>
		</div><?php }
}
